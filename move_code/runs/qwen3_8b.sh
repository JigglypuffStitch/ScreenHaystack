...
export NOT_IN_SUBSET="${WORKSPACE_ROOT}/blind_zone/find_zone/8b/output_screenspot_8b_not_in_worst_cells.jsonl"
export WORST_SUBSET="${WORKSPACE_ROOT}/blind_zone/find_zone/8b/worst_cells_8b.jsonl"
export REGION_BBOX="${WORKSPACE_ROOT}/worst_cells_8b.jsonl"
export OUTPUT_DIR="${WORKSPACE_ROOT}/blind_zone/find_zone/8b"
export OUTPUT_TAG="qwen8b"
